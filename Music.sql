...
most money*/
select c.customer_id, concat(c.first_name,' ',c.last_name) as Name , sum (i.total) as total from customer c
...
select at.name, at.artist_id,count(at.artist_id) as number_of_songs
from track t
